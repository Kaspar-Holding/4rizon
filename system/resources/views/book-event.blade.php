...
<body class="body-6">
    ...
    <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" data-doc-height="1" role="banner" class="navbar-2 w-nav">
      <div class="w-container">
        ...
        <nav role="navigation" class="nav-menu-2 w-nav-menu">
          ...
          <a href="{{ route('book-event') }}" class="nav-link-3 button w-nav-link w--current">Book Event</a>
        </nav>
  ...
  <div class="section wf-section">
    <div class="w-container">
      <div>
        <h1 class="heading-21">Book Event</h1>
    ...
    <div class="container-4 w-container">
      <div class="div-block-17">
        <div class="w-layout-grid grid-10">
          <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80ba-e08abbc6" class="div-block-20">
          ...
          <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80bd-e08abbc6">
            <h1 class="heading-10">Contact Us</h1>
            <div class="w-layout-grid grid-11">
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80c1-e08abbc6"><img src="images/icon-03.webp" loading="lazy" width="696" id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80c2-e08abbc6" sizes="(max-width: 479px) 57vw, (max-width: 767px) 91vw, 695.9942626953125px" srcset="images/icon-03-p-500.webp 500w, images/icon-03-p-800.webp 800w, images/icon-03.webp 1392w" alt="" class="image-2"></div>
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80c3-e08abbc6">
                <h6 class="heading-11">Fourways, Johannesburg</h6>
              </div>
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80c6-e08abbc6"><img src="images/icon-04.webp" loading="lazy" id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80c7-e08abbc6" srcset="images/icon-04-p-500.webp 500w, images/icon-04-p-800.webp 800w, images/icon-04.webp 1392w" sizes="(max-width: 479px) 48vw, (max-width: 767px) 95vw, (max-width: 991px) 727.9923706054688px, 939.9999389648438px" alt="" class="image-3"></div>
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80c8-e08abbc6">
                <h6 class="heading-12">Fourways, Johannesburg</h6>
              </div>
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80cb-e08abbc6"><img src="images/icon-05.webp" loading="lazy" id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80cc-e08abbc6" srcset="images/icon-05-p-500.webp 500w, images/icon-05-p-800.webp 800w, images/icon-05.webp 1392w" sizes="(max-width: 479px) 48vw, (max-width: 767px) 95vw, (max-width: 991px) 727.9923706054688px, 939.9999389648438px" alt="" class="image-4"></div>
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80cd-e08abbc6" class="div-block-29">
                <h6 class="heading-13">Fourways, Johannesburg</h6>
              </div>
            </div>
          </div>
          <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80d0-e08abbc6">
          ...
          <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80d9-e08abbc6">
            <div class="w-layout-grid grid-26">
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80db-e08abbc6">
              ...
              <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80e6-e08abbc6"><img src="images/Download-App-02-1.png" loading="lazy" alt=""></div>
            </div>
          </div>
        </div>
        <div id="w-node-_260c6ab4-3932-0ec5-add0-2c7294cf80e8-e08abbc6">
