...
class UserEmails extends Model
{
    ...
    public static function signUpEmail($useremail, $link){
        $email = new Mail();
        $email->setFrom("4rizontech@gmail.com", "4RIZON Contact");
                    ...
                    <div style='max-width:600px;margin:0 auto'>
                        <div style='background:#fff;font:14px sans-serif;color:#686f7a;border-top:4px solid #ce171f;margin-bottom:20px;border-bottom: 4px solid #ce171f;'>
                            <div class='border-bottom:1px solid #f2f3f5;padding:20px 30px'>
                                <img src=\"http://kaspar.eastus.cloudapp.azure.com/4RIZON_testing/new/images/4RIZONlogo.jpeg\" alt='4RIZON' style='max-width:115px;display:block;margin: 10px 29px;'>
                            </div>
                            <div style='padding:20px 30px'>
                                <div style='font-size:16px;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:20px'>
                                    ...
                                    <p><a style='text-decoration:none;color:#000'><strong>Note:</strong> Contact us <strong><a href='https://4RIZON.co.za' target='_blank'>Here</a></strong> immediately if you did not authorize this registration.</a></p>
                                </div>
                            </div>
                        </div>
                        <div style='font:11px sans-serif;color:#3e3e3e'>
                            Delivered by 4RIZON.co.za - All Rights Reserved.
                        </div>
                    </div>
                </div>"
        );
                    ...
                    <div style='max-width:600px;margin:0 auto'>
                        <div style='background:#fff;font:14px sans-serif;color:#686f7a;border-top:4px solid #ce171f;margin-bottom:20px;border-bottom: 4px solid #ce171f;'>
                            ...
                            <div style='padding:20px 30px'>
                                <div style='font-size:16px;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:20px'>
                                    <p><a style='text-decoration:none;color:#000'>Welcome <strong>".$useremail."</strong>,</a></p>
                                    <p><a href='http://kaspar.eastus.cloudapp.azure.com/4RIZON_testing/reset_password'>Reset Your Account password here </a></p>
                                    <p><a style='text-decoration:none;color:#000'><strong>Note:</strong> Contact us <strong><a href='https://4RIZON.co.za' target='_blank'>Here</a></strong> immediately if you did not make this request.</a></p>
                                </div>
                            </div>
                        </div>
                        <div style='font:11px sans-serif;color:#3e3e3e'>
