            ...
            <div class="white_shd full margin_bottom_30">
              ...
              <form class="container-fluid" action="{{route ('update_event')}}" method="POST" enctype="multipart/form-data" style="padding:30px; padding-bottom:40px;">
                ...
                <div>
                  ...
                  <input type="text" name="event_price" class="form-control" value="{{ $event->pkg_price }}" >
                </div>
                <br>
                <div>
                ...
                <div>
                  ...
                  <input type="text" name="stage_1" class="form-control" value="{{ $event->stage_1 }}" required>
                </div>
                <br>
                <div>
                  <label class="form-label">Stage 2</label>
                  <input type="text" name="stage_2" class="form-control" value="{{ $event->stage_2 }}" required>
                </div>
                <br>
                <div>
                  <label class="form-label">Stage 3</label>
                  <input type="text" name="stage_3" class="form-control" value="{{ $event->stage_3 }}" required>
                </div>
                <br> 
                <div>
