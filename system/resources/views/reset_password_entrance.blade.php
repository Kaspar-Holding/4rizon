            ...
            <div class="center verticle_center full_height">
               <div class="row" style="width:100%;height:100vh;">
                  ...
                  <div class=" col-md-7 login_form">
                    ...
                    @endif
                     <form method="POST" action="{{ route('update_password_entrance') }}" class="login_section">
                        @csrf
                        ...
                        <fieldset>
                           <div class="field" style="margin:0px!important; justify-content:center;">
                              ...
                              <input  style="background:#e8f0fe!important; color:black; !important" type="email" class="login-in" name="email" :value="old('email')" required placeholder="Enter Email" />
