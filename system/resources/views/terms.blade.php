      ...
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner event_section">
          <div class="carousel-item active">
            <div class="text-center col-lg-12 col-md-12 col-sm-6 event"><h1>END USER LICENCE AGREEMENT</h1>
            <p class="text-justify">


4RIZON is licensed to You (End-User) by 4RIZON (Pty) Ltd, located and registered at The Buzz Shopping Centre, Fourways, Gauteng, South Africa ('Licensor'), for use only under the terms of this Licence Agreement. <br>
...
12. TERMINATION<br>
13. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY<br>
...
1. THE APPLICATION<br>
<br>
4RIZON ('Licensed Application') is a piece of software created to facilitate the registration of patrons, the online booking process for access to 4RIZON, payments, the purchase of merchandise, etc -and customised for iOS and Android mobile devices ('Devices'). <br>
<br>
2. SCOPE OF LICENCE<br>
<br>
...
<br>
2.2  	This licence will also govern any updates of the Licensed Application provided by Licensor that 	replace, repair, and/or supplement the first Licensed Application, unless a separate licence is 	provided for such update, in which case the terms of that new licence will govern.<br>
<br>
2.3  	You may not share or make the Licensed Application available to third parties (unless to the 	degree allowed by the Usage Rules, and with 4RIZON (Pty) Ltd's prior written consent), sell, 	rent, lend, lease or otherwise redistribute the Licensed Application.<br>
<br>
2.4 	 You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, 	combine, create derivative works or updates of, adapt, or attempt to derive the source code 	of the Licensed Application, or any part thereof (except with 4RIZON (Pty) Ltd's prior written 	consent).<br>
<br>
2.5  	You may not copy (excluding when expressly authorised by this licence and the Usage Rules) or alter the Licensed Application or portions thereof. You may create and store copies only on devices that You own or control for backup keeping under the terms of this licence, the Usage Rules, and any other terms and conditions that apply to the device or software used. You may not remove any intellectual property notices. You acknowledge that no unauthorised third parties may gain access to these copies at any time. If you sell your Devices to a third party, you must remove the Licensed Application from the Devices before doing so.<br>
<br>
...
<br>
2.8 	Nothing in this licence should be interpreted to restrict third-party terms. When using the Licensed Application, You must ensure that You comply with applicable third-party terms and conditions. <br>
<br>
<br>
<br>
3. TECHNICAL REQUIREMENTS <br>
<br>
3.1  	The Licensed Application requires a firmware version 2.0 or higher. Licensor recommends using the latest version of the firmware. <br>
<br>
3.2  	Licensor attempts to keep the Licensed Application updated so that it complies with modified/new versions of the firmware and new hardware. You are not granted rights to claim such an update. <br>
<br>
3.3  	You acknowledge that it is Your responsibility to confirm and determine that the app end-user device on which You intend to use the Licensed Application satisfies the technical specifications mentioned above.<br>
<br>
3.4  	Licensor reserves the right to modify the technical specifications as it sees appropriate at any time.<br>
<br>
<br>
4. MAINTENANCE AND SUPPORT<br>
<br>
4.1  	The Licensor is solely responsible for providing any maintenance and support services for this Licensed Application. You can reach the Licensor at the email address listed in the App Store or Play Store Overview for this Licensed Application.<br>
<br>
4.2  	4RIZON (Pty) Ltd and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.<br>
<br>
<br>
5. USER-GENERATED CONTRIBUTIONS<br>
<br>
The Licensed Application may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or in the Licensed Application, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, 'Contributions'). Contributions may be viewable by other users of the Licensed Application and through third-party websites or applications. As such, any Contributions you transmit may be treated as non-confidential and non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that:<br>
<br>
...
<br>
5. 	Your Contributions are not unsolicited or unauthorised advertising, promotional materials, pyramid schemes, chain letters, spam, mass mailings, or other forms of solicitation.<br>
<br>
6. 	Your Contributions are not obscene, lewd, lascivious, filthy, violent, harassing, libellous, slanderous, or otherwise objectionable (as determined by us).<br>
<br>
...
<br>
13. 	Your Contributions do not otherwise violate, or link to material that violates, any provision of this Licence Agreement, or any applicable law or regulation.<br>
<br>
Any use of the Licensed Application in violation of the foregoing violates this Licence Agreement and may result in, among other things, termination or suspension of your rights to use the Licensed Application.<br>
<br>
<br>
6. CONTRIBUTION LICENCE<br>
<br>
By posting your Contributions to any part of the Licensed Application or making Contributions accessible to the Licensed Application by linking your account from the Licensed Application to any of your social networking accounts, you automatically grant, and you represent and warrant that you have the right to grant, to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and licence to host, use copy, reproduce, disclose, sell, resell, publish, broad cast, retitle, archive, store, cache, publicly display, reformat, translate, transmit, excerpt (in whole or in part), and distribute such Contributions (including, without limitation, your image and voice) for any purpose, commercial advertising, or otherwise, and to prepare derivative works of, or incorporate in other works, such as Contributions, and grant and authorise sublicences of the foregoing. The use and distribution may occur in any media formats and through any media channels.<br>
<br>
...
<br>
7.2  	Licensor takes no accountability or responsibility for any damages caused due to a breach of duties according to Section 2 of this Licence Agreement. To avoid data loss, You are required to make use of backup functions of the Licensed Application to the extent allowed by applicable third-party terms and conditions of use. You are aware that in case of alterations or manipulations of the Licensed Application, You will not have access to the Licensed Application.<br>
<br>
<br>
8. WARRANTY<br>
<br>
8.1  	Licensor warrants that the Licensed Application is free of spyware, trojan horses, viruses, or any other malware at the time of Your download. Licensor warrants that the Licensed Application works as described in the user documentation.<br>
<br>
8.2 	 No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorisedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of 4RIZON (Pty) Ltd's sphere of influence that affect the executability of the Licensed Application.<br>
<br>
8.3 	 You are required to inspect the Licensed Application immediately after installing it and notify 4RIZON (Pty) Ltd about issues discovered without delay by email provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been emailed within a period of ten (10) days after discovery.<br>
<br>
8.4  	If we confirm that the Licensed Application is defective, 4RIZON (Pty) Ltd reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.<br>
<br>
...
9. PRODUCT CLAIMS<br>
<br>
4RIZON (Pty) Ltd and the End-User acknowledge that 4RIZON (Pty) Ltd, and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User’s possession and/or use of that Licensed Application, including, but not limited to:<br>
<br>
...
<br>
(iii) 	claims arising under consumer protection, privacy, or similar legislation, including in connection with Your Licensed Application’s use of the HealthKit and HomeKit.<br>
<br>
<br>
10. LEGAL COMPLIANCE<br>
<br>
You represent and warrant that You are the registered End User associated with the registered cellphone number and/or email address and that Your details as registered with the Department of Home Affairs are correct at the time of registration on the Licensed Application and are located within the Republic of South Africa.
<br>
<br>
<br>
...
12. TERMINATION<br>
<br>
The licence is valid until terminated by 4RIZON (Pty) Ltd or by You. Your rights under this licence will terminate automatically and without notice from 4RIZON (Pty) Ltd if You fail to adhere to any term(s) of this licence. Upon Licence termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.<br>
<br>
<br>
13. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY<br>
<br>
...
14. INTELLECTUAL PROPERTY RIGHTS<br>
<br>
4RIZON (Pty) Ltd and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, 4RIZON (Pty) Ltd, and not the Services, will be solely responsible for the investigation, defence, settlement, and discharge or any such intellectual property infringement claims.<br>
<br>
<br>
15. APPLICABLE LAW<br>
<br>
This Licence Agreement is governed by the laws of South Africa excluding its conflicts of law rules.<br>
<br>
<br>
16. MISCELLANEOUS<br>
<br>
16.1  	If any of the terms of this agreement should be or become invalid, the validity of the remaining provisions shall not be affected. Invalid terms will be replaced by valid ones formulated in a way that will achieve the primary purpose.<br>
<br>           
16.2  	Collateral agreements, changes and amendments are only valid if laid down in writing. The preceding clause can only be waived in writing.<br>
<br>
</p>
            <hr />
            <h1>TERMS & CONDITIONS INTERPRETATION</h1>
            <p class="text-justify">
These Terms and Conditions may contain several terms and phrases which have a specific meaning in this document. Any reference to a party shall, if such party is liquidated or sequestrated, also apply to and be binding upon that party's liquidator or trustee. Unless we show to the contrary in these Terms and Conditions, references to gender includes the other genders, the singular includes the plural and the other way around.<br>
<br>
DEFINITIONS<br>
The following expressions shall bear the meanings assigned to them below:<br>
"3rd Party Websites" means websites other than the 4RIZONSites;<br>
"Access" when used in a website (whether it be the Sites or a 3rd Party Website), means to visit, use, load in a web browser, mobile phone or similar software application or device or otherwise engage with a website;<br>
"Branded Sites" means Famous Brands and 4RIZONbranded sites which include branded accounts, pages and websites hosted by or on the Social Networks;<br>
"Content" means all information (such as data files, written text, computer software, music, audio files or other sounds, photographs, videos or other images) which You may have access to as part of, or through your use of, the Sites;<br>
"the ECT Act" means the Electronic Communications and Transactions Act 25 of 2002;<br>
"Facebook" means Facebook Inc. as well as the social network located at http://facebook.com, as the context dictates;<br>
"Intellectual Property" means, collectively, the patents, copyrights (and moral rights), trademarks, designs, models, brands, names, trade names, graphics, icons, hyperlinks, know-how, trade secrets and any other type of intellectual property (whether registered or unregistered including applications for and rights to get or use same) which We own, license, use and/or hold;<br>
“4RIZON App” means the software application owned by 4RIZON which allows users to order products and/or services via the application;
"know-how" means all the ideas, designs, documents, diagrams, information, devices, technical data, secrets and other processes and methods We use in connection with the Sites, as well as all available information regarding marketing and promotion of the Goods and services described in these Terms and Conditions, as well as all and any modifications or improvements to any of them;<br>
“Online Apps” means the 4RIZON App and/or 4RIZON Website or both where applicable;<br>
“POPI Act” means the Protection of Personal Information Act 4 of 2013;<br>
"Post" means to upload, publish, transmit, share or store;<br>
"Promotion and Competition Rules" means the individual terms and conditions applicable to and governing all 4RIZON promotions and competitions, which are available on this Website;<br>
"Properties" means properties or content on which we show advertisements;<br>
"Remarketing Lists" means a list of User Cookies created or otherwise obtained by You and used for remarketing or similar audiences;<br>
"RIC Act" means the Regulation of Interception of Communications and Provision of Communication Related Information Act 70 of 2002;<br>
"Similar Audiences Lists" means a list of Users created by Google based on a Remarketing List for connection with similar audiences;<br>
"Social Networks” Terms of Use" means the terms and conditions governing the Social Networks’ services and/or platforms from time to time;<br>
"Social Networks" means online social networks, social media and similar communication tools including, but not limited to, blogs, Facebook, WhatsApp and Twitter;<br>
"The Sites" means this Website, Online Apps and the Branded Sites ("Site" is a reference to any of the Sites, as the context permits or shows);<br>
"Terms and Conditions" means these Terms and Conditions of use, as amended from time to time;<br>
"Trademarks" means those trademarks We own (or which We are designated as the beneficial owner of) and any other trademarks, designs, logos, style names, tag lines and slogans which We own or have the right to use or any derivative service offerings of, and applications for, any of same;<br>
"Twitter" means Twitter Inc. as well as the social network and messaging platform tools accessible through http://twitter.com;
"Us", "We", “Our” means 4RIZON, a company with limited liability incorporated following the company laws of the Republic of South Africa (registration number ……………………/07);<br>
"User/s" means anyone who accesses the Sites within the meaning of the term "Access" above;<br>
"Unique User" means a unique instance of a browser, application or similar technology;<br>
"User Cookie" means the User identifier (of which a cookie is one example) associated with a User for remarketing or similar audiences;<br>
“WhatsApp” means WhatsApp LLC. as well as the social network and messaging platform tools accessible through WhatsApp.com,
"You" means visitors to the Sites;<br>
<br>
GENERAL<br>
...
<br>
GOODS AND DELIVERY OF GOODS (ONLINE ORDERING VIA THE WEBSITE OR ONLINE APPS)<br>
The goods (“Goods”) offered by 4RIZON are indicated on this Website or the Online Apps, as updated from time to time.<br>
The photos used on the Sites are for illustration purposes only. Actual Goods may vary. <br>
The prices of the Goods are indicated on the Sites, as updated from time to time and will vary depending on the type, quantity and/or size of the Goods ordered as well as any variations, amendments or upgrades made thereto. <br>
<br>
PRICE AND PAYMENT<br>
Prices will be as quoted on this application or website. These prices include VAT but may exclude delivery, service, preparation, order size, and similar costs, which will be added to the total amount due (if you opt for delivery instead of collection), where applicable.
Payment methods. Payment for all orders must be by credit or debit card as stated on this application or website, alternatively, in cash at the point of collection or delivery to you.<br>
...
Delays in payments. Please note that from time to time there may be delays with processing payments and transactions; on occasion, this may result in payments taking up to 60 days to be deducted from your bank account or charged to your credit card.<br>
<br>
PAYMENTS AND REFUNDS<br>
Payments<br>
We are committed to providing secure online payment facilities. All transactions are encrypted using appropriate encryption technology. Payment may be made for Goods via the following methods (depending on its availability and/or your eligibility to use such a method) -<br>
<br>
debit card: where payment is made by debit card, we may require additional information to authorise and/or verify the validity of payment. In such cases we are entitled to withhold delivery until the additional information is received by us and authorisation is obtained by us for the amounts. If we do not receive authorisation your order for the Goods will be cancelled. You warrant that you are fully authorised to use the debit card supplied for purposes of paying for the Goods. You also warrant that your debit card has sufficient available funds to cover all the costs incurred as a result of the services used on the Website or Online Apps;<br>
...
<br>
Refunds<br>
Refunds will be processed via the contact centre. Where a customer provides 4RIZON with the incorrect account information, and a refund is successfully processed to the provided details, 4RIZONwill not be held responsible for any further refunds. Card reversals may take up to 14 business days to reflect. A valid proof of refund by 4RIZON’s card processing partner shall be conclusive proof that a card reversal has been processed. Should a refund not reflect, the customer will have to approach their card issuing institution to investigate the matter.<br>
<br>
Errors<br>
We shall take all reasonable efforts to accurately reflect the description, availability, purchase price and delivery charges of Goods on the Website and Online Apps. However, should there be any errors of whatsoever nature on the Website or Online Apps (which are not due to our gross negligence), we shall not be liable for any loss, claim or expense relating to a transaction based on any error, save – in the case of any incorrect purchase price – to the extent of refunding you for any amount already paid.<br>
<br>
4RIZON shall not be bound by any incorrect information regarding our Goods displayed on any third-party websites.<br>
<br>
DEALS AND OTHER DISCOUNTED GOODS<br>
From time to time, we may offer certain Goods at discounted prices as part of a deal or 4RIZON App only deal (the Deal”). These will be subject to certain conditions as set out on the Sites. If you purchase a product within the scope of a Deal, you will pay the discounted price for that product. However, if you buy a product in a manner that falls outside of the scope of a Deal, then you will pay the then-current selling price on the Sites for each product that falls outside the scope of the Deal.<br>
<br>
<br>
LEGAL AGE AND CAPACITY<br>
You may not access the Sites and may not accept these Terms and Conditions if You lack the legal capacity to enter into a binding contract with Us; are a person barred from Accessing the Sites under the laws of the Republic of South Africa or other countries including the country in which You are resident or from which You Access the Sites. By accessing the Sites and/or the Content, You represent and warrant that You are of full legal age or are emancipated or have your parent/guardian's consent to enter into a contract, being these Terms and Conditions.<br>
...
When You register on the Sites You may be asked to select a username and password which You will use to secure your account. Once registered You will be able to log into your account using your username and your password or your relevant account information with your preferred authentication service. To complete the registration process, You may be required to submit information about yourself and your preferences to Us ("Registration Data"). The use of your Registration Data is dealt with in our Privacy Policy below, which, for the avoidance of doubt, forms part of these Terms and Conditions.<br>
You warrant that the Registration Data is accurate, current and complete (this includes Registration Data We may receive from the providers). You will be denied access to the Sites should You breach this warranty or subsequently be found to have breached this warranty.<br>
We may take steps to verify your Registration Data once You have completed the requisite registration process using a verification email sent to your given email address. You agree to this verification process and irrevocably consent to Us gaining Access to relevant information held by 3rd parties (including, but not limited to the Social Networks) which may be required to reasonably complete the verification process. You acknowledge and agree that access to the Sites may be limited until the verification process has been completed.<br>
Should You not agree to the verification process as contemplated above or withhold your consent, your Access to the Sites, generally, may be suspended or terminated and You waive any claims You may have against Us, 4RIZON Associates, Our officers, directors, employees, servants, agents and/or contractors arising out of Our denial of Access to You to the Sites.
You agree that the security of your account is solely your responsibility.<br>
<br>
You further agree that:
•	You are responsible for maintaining and promptly updating the Registration Data and any other information You provide Us with, thereby keeping it accurate, current and complete;<br>
•	if You believe that information or Content posted to the Sites infringes on any person's rights in any way, You will notify Us immediately;<br>
•	if You believe the security of your registration on the Sites has been compromised in any way, You will notify Us (in the case of This Website) or the relevant provider (in the case of the Branded Sites) immediately;<br>
...
•	if any security violations are believed to have occurred in association with your account, We reserve the right to suspend access to your account pending an investigation and resolution.<br>
•	The User warrants that all orders for Goods placed with the Users account are made by the User or with the Users express consent and that the User will be responsible for the payment of any orders for Goods in respect of the User's account.<br>
<br>
USERS’ CODE OF CONDUCT<br>
You may not Access the Content or the Sites for or in conjunction with any illegal, unlawful or immoral purposes or for purposes prohibited by these Terms and Conditions.<br>
You may not frame the Sites in any way whatsoever except as permitted by the Sites’ functionality (details may be found on the Sites concerned) or otherwise without our prior written permission. Recognising the global nature of the Internet, You agree to comply with all local laws, rules and regulations regarding your conduct on the Sites as well as the providers’ terms.<br>
You agree to adhere to generally acceptable Internet and email etiquette. In this regard, without being limited to the examples listed below, <br>
You agree not to:<br>
•	engage in any abuse of email or spamming, including, without being limited to – the Posting or cross–Posting of unsolicited Content with the same or substantially the same message to recipients that did not request to receive such messages; and inviting people who You may be connected to using 3rd party services (including, but not limited to the Social Networks) to Access the Sites where those people may not wish to receive such invitations or similar communications (in other words, make sure your contacts on other services are receptive to receiving invitations to joining Us and Accessing the Sites or other communications You send them from Us);<br>
•	engage in any activity intended to entice, solicit or otherwise recruit website users to join an organisation except where We expressly authorise such activities in writing;<br>
•	take any action aimed at deceiving or misleading any person, attempt to impersonate or misrepresent your affiliation to any person or forge headers or otherwise manipulate identifiers to disguise the origin of anything Posted through the Sites;<br>
•	use the Sites to Post anything defamatory, discriminatory, obscene, offensive, threatening, abusive, harassing, harmful, hateful or which carries child pornography, religious or racial slurs or threatens or encourages bodily harm or the like or which may violate any person's personality rights;<br>
•	use the Sites to make fraudulent offers to sell or buy products, items or services or to offer or solicit for any type of scam such as "pyramid schemes" and "chain letters";<br>
•	use the Sites in a manner that may infringe the intellectual property rights (for example copyright or trademarks) or other proprietary rights of others (including, but not limited to, the Intellectual Property);<br>
•	use the Sites in any manner which could damage, impair, overburden or disable the Sites or interfere with any other party's Access to the Sites;<br>
•	use the Sites to Post anything which contains viruses or any other destructive features, regardless of whether or not damage is intended;<br>
•	gather email addresses and/or names for commercial, political, charity or like purposes or use the services to collect or attempt to collect personal information about third parties without their knowledge or consent;<br>
...
•	otherwise use the Sites to engage in any illegal or unlawful activity.<br>
Should You engage in any one or more of the above practices, which shall be determined in our sole discretion (and which decision shall be final), then We shall be entitled, without prejudice to any other rights We may have, to:<br>
...
•	hold You liable for any costs or damages We incur as a result of your misconduct; and/or<br>
•	notwithstanding our Privacy Policy referred to below, disclose any information relating to You, whether public or personal, to all persons affected by your actions.<br>
PROMOTIONS AND COMPETITIONS<br>
We may conduct promotions and competitions from time to time on one or more of the Sites or at the 4RIZON venue . Each promotion and competition will have its specific terms and conditions which apply to and govern them. These Promotion and Competition Rules will be available on the Website.<br>
<br>
LICENSES<br>
Our license to You<br>
We grant You a personal, revocable, worldwide, royalty-free, non–commercial, non–transferrable and non–exclusive license to access the Content on the Sites. This license is for the sole purpose of enabling You to Access the Sites, in the manner permitted by these Terms and Conditions. In the event We revoke this license, You may no longer access the Sites or the Content on the Sites.<br>
...
Unless We have given You specific written permission to do so, You may not transfer, through an assignment of rights, sublicense or otherwise, your rights to use the Sites or otherwise transfer any part of your rights to use the Sites.<br>
To the extent that any copying, reproduction, distribution, transmission, display, broadcasting or publishing of any Content is expressly permitted (such permission to be interpreted in its most restrictive sense) You may do so, provided that all trademarks, trade names and all copyright, ownership, proprietary and confidentiality notices as are included on the original Content are retained and displayed without alteration or modification and not in any manner obscured or removed.<br>
...
•	the purpose of caching is to make the onward transmission of the Content from the Sites more efficient;<br>
•	the cached Content is not modified in any manner whatsoever;<br>
•	the cached Content is updated at least every 12 (twelve) hours; and<br>
•	the cached Content is removed or updated when We so require.<br>
<br>
<br>
<br>
<br>
Your license to Us<br>
We do not claim any ownership rights in the Content that You Post to the Sites. You retain any rights that You may already have in your Content when You Post your Content to or otherwise access the Sites, subject to the limited license You grant to Us.<br>
By posting any Content on or through the Sites, You grant Us an irrevocable, non–exclusive, commercial, fully-paid, royalty-free, transferrable and worldwide license to moderate, use, modify, delete from, add to, publicly perform, publicly display, reproduce, commercialize or otherwise distribute such Content on or through the Sites including without limitation, distributing part or all of the Sites or Content in any media formats and through any media, partners' or affiliate channels and make use of the Content in our advertising campaigns.<br>
<br>
The license You grant to Us means that:<br>
You are free to license your Content to anyone else in addition to Us;<br>
We may make commercial use of your Content or otherwise commercialise your Content;<br>
We are not required to pay You for the use of the Content You Post to the Sites;<br>
We can use our affiliates, subcontractors and other partners (such as Internet content delivery networks and wireless carriers) to grant access to the Sites; and<br>
the license extends to anywhere in the world because of the global nature of the Internet and the fact that our users can access the Content from anywhere in the world.<br>
<br>
GENERAL ISSUES YOU SHOULD BE AWARE OF:<br>
Because You can only lawfully license Content You have certain rights in, You represent and warrant that:<br>
•	You own the Content You Posted on or through the Sites or otherwise have the right to grant the license outlined in this section; and<br>
•	Posting your Content on or through the Sites does not violate the privacy rights, publicity rights, copyright, contractual rights or any other rights of any person or entity.<br>
•	You also agree to pay for all royalties, fees, and any other monies owing to any person or entity because of any Content You Post on or through the Sites.<br>
<br>
LIABILITY<br>
Disclaimers And Limitation of Liability<br>
(“We” and “us” in the context of this disclaimer and limitation of liability includes 4RIZON, their affiliated companies and subsidiaries). Your use of and reliance on the sites is entirely at your own risk. The sites are provided "as is".<br>
<br>
Although we take steps to verify information presented on or through the sites, we do not represent or endorse the accuracy or reliability of any advice, opinion, statement or other information contained in, displayed on, linked to or distributed through the sites or the content other users may publish to the sites. You acknowledge that any reliance upon any such opinion, advice, statement or information shall be at your sole risk. We reserve the right, in our sole discretion, to correct any errors or omissions on the sites without notice to you.<br>
Information, ideas and opinions expressed on or through the sites should not be regarded as professional advice or our official opinion and you are strongly advised to seek professional advice before acting on such information.<br>
To the fullest extent permissible by applicable law, we disclaim all warranties of any kind, whether express or implied, including without limitation to the implied warranties that the content published to the sites (or the sites themselves, for that matter) is fit for any purpose other than as a reference work in respect of the content provided on the sites. Whilst we take reasonable precautions in our operation of the sites, you agree that neither we nor 4RIZON’s associates shall be liable in respect of any loss, damage or damages however arising and whatever the cause, in particular, according to and in furtherance of these terms and conditions, your access to the sites or from your inability to access the sites. We will use reasonable endeavours to make the sites available to you and always keep the sites available to you. However, you agree that we shall not be liable in respect of any loss or damage caused by or arising from the unavailability of, any interruption in or your access to the sites (either in part or as a whole) for any reason whatsoever.<br>
<br>
INDEMNITY<br>
You hereby indemnify us and 4RIZON’s associates from any loss, damages, liability, claim or demand due to or arising out of your use of the sites or breach by you of these terms and conditions. We are not responsible for files and data residing on your account or for any contributions you may have made to the sites. You agree to take full responsibility for files and data transferred and your content as well as to maintain all appropriate backup of files and data stored on our servers.<br>
<br>
RIGHTS INFRINGEMENT<br>
If You are of the view that your rights have been infringed through the unlawful use of the Sites by registrants or 3rd parties, You may address a complaint to Us which satisfies the following requirements and/or contains the following information:<br>
•	the full names and address of the complainant;<br>
•	the written or electronic signature of the complainant;<br>
•	identification of the right that has allegedly been infringed;<br>
•	identification of the material or activity that is claimed to be the subject of unlawful activity;<br>
•	the remedial action required to be taken by the service provider in respect of the complaint;<br>
•	telephonic and electronic contact details, if any, of the complainant;<br>
•	a statement that the complainant is acting in good faith; and<br>
•	a statement by the complainant that the information in the takedown notification is to his or her knowledge true and correct.<br>
<br>
...
This Website is controlled and maintained from our facilities in the Gauteng province of the Republic of South Africa. You irrevocably agree that the law of the Republic of South Africa shall govern This Website and these Terms and Conditions. You consent to the jurisdiction of the High Court of the Republic of South Africa, Gauteng Provincial Division held at Johannesburg, South Africa in respect of disputes which may arise out of your Access to This Website and these Terms and Conditions. To the maximum extent permitted by applicable law, You also irrevocably and unconditionally consent to the jurisdiction of the Magistrates Court (if We exercise proceedings in such Court) even though the value of a claim which We may have against You may exceed the ordinary monetary jurisdiction of the Magistrates Court.<br>
<br>
SEVERABILITY<br>
Any provision in these Terms and Conditions which is or may become illegal, invalid or unenforceable shall be ineffective to the extent of such prohibition or unenforceability and shall be treated as if it were not written and severed from these Terms and Conditions, without invalidating the remaining provisions of these Terms and Conditions.<br>
<br>
TERMINATION<br>
...
GENERAL TERMS<br>
You agree that:<br>
•	You are bound by these Terms and Conditions;<br>
•	this agreement shall be deemed to have been concluded in Johannesburg at the time You access the Sites for the first time;<br>
•	data messages addressed by You to Us shall be deemed to have been:<br>
•	received if and when responded to;<br>
•	sent by You within the geographical boundaries of the Republic of South Africa;<br>
•	You shall be deemed to have been received data messages We address to You as detailed in section 23(b) of the ECT Act;<br>
•	electronic signatures, encryption and/or authentication are not required for valid electronic communications between You and Us;<br>
•	as well as warrant that data messages that You send to Us from a computer, IP address or mobile device normally used by You, was sent and/or authorised by You personally.<br>
These Terms and Conditions constitute the whole agreement between You and Us relating to your Access to and use of the Sites. No indulgence, extension of time, waiver or relaxation of any of the provisions or terms of these Terms and Conditions which We may show, grant or allow You shall operate as an estoppel against Us in respect of its rights under these Terms and Conditions nor shall it constitute a waiver by Us of any of our rights and We shall not thereby be prejudiced or stopped from exercising any of its rights against You which may have arisen in the past or which might arise in the future. Nothing in this agreement shall create any relationship of agency, partnership or joint venture between You and 4RIZON and You shall not hold itself out as the agent or partner of 4RIZON.<br>
<br>
REMARKETING<br>
4RIZON uses all features of Analytics for “Display Advertisers” this allows us to collect certain information and to provide visitors (You) with tailored information upon each visit. This includes obtaining specific visitor cookie data, such as the source, medium and keyword used to visit this Website. Google Analytics however does not store any visitor specific data and We will not use visitor specific data in any way related to Analytics, Google Adwords, and Remarketing. Cookies are a common part of many commercial websites that allow small text files to be sent by a website, accepted by a web browser and then placed on your hard drive as recognition for repeat visits to the site. Every time You visit this Website, Our servers, through cookies, pixels and/or GIF files, collect basic technical information as described.<br>
...
4RIZON uses remarketing and Analytics to display content specific advertisements to visitors that have previously visited this Website when those visitors go to other websites that have the Display Network implemented.<br>
4RIZON and other third-party vendors, including Google, use first-party cookies (such as the Google Analytics cookie) and third-party cookies together to inform, optimize, and serve ads based on visitor’s past visits to Our Website.<br>
...
(a) 	Running ads that collect Personally Identifiable Information including, but not limited to, 	email addresses, telephone numbers, and credit card numbers; and<br>
(b) 	Creating a remarketing list or creating ad text that specifically targets users in ways that are 	outlined as "prohibited" in the categories below.<br>
Visitors/Users can opt-out of Analytics for Display Advertisers and opt-out of customised Google Display Network ads by visiting the Ad Preferences Manager<br>
<br>
CREATION, MIGRATION AND USE OF REMARKETING LISTS<br>
We must have all rights necessary to create or otherwise obtain Remarketing Lists, migrate Remarketing Lists to, and use Remarketing Lists or Similar Audience Lists on the Properties. Google will not allow another advertiser to use your information in the Remarketing Lists or Similar Audiences Lists without your consent.<br>
<br>
SOFTWARE AND EQUIPMENT<br>
It is your responsibility to acquire and maintain, at your own expense, the computer hardware, software, communications infrastructure and access accounts required to access the Sites.<br>
<br>
ECT ACT<br>
...
"Communications" means messages, notices, documents and/or other materials which are published to or disseminated through the Social Networks;<br>
"Contractors" means any legal or natural person who is contracted to render services or provide products to 4RIZON and who is not an Employee of 4RIZON ("Contractor" has a corresponding meaning);<br>
"Employees" means 4RIZON’s Employees ("Employee" has a corresponding meaning);<br>
"Social Networks" means online social networks, social media generally and similar communication tools including, but not limited to, blogs, Facebook, WhatsApp and Twitter;<br>
"Social Terms" means the terms and conditions set out in this document;<br>
<br>
COMMUNICATIONS PURPOSE<br>
The Communications are intended to provide general information regarding 4RIZON, its products, goods and services, and other information which may be of interest to you. The information presented in or through the Communications including all research, opinions or other content is not intended to and does not constitute financial, accounting, tax, legal, investment, consulting or other professional advice or services. 4RIZON does not act or purport to act in any way as a financial advisor or a fiduciary capacity. <br>Before making any decision or taking any action which might affect your finances or business you should take appropriate advice from a suitably qualified professional or financial adviser. Communications may include technical, typographical or other inaccuracies and you are urged to contact 4RIZON to confirm all information contained in the Communications before placing any reliance on it. <br>Changes are periodically made to the information presented through the Communications and these changes may be incorporated in new Communications. 4RIZON reserves the right to alter or amend any criteria or information set out in the Communications without notice. If the Communications contain statements or information which relate to projections, plans or objectives or future economic performance you should be aware that these projections are only predictions and that actual events or results may differ materially. Representations and opinions are provided for information purposes only.<br>
<br>
CONFIDENTIALITY<br>
The Communications may contain information that is confidential, private or privileged. If you are not the intended recipient of this information (or the intended recipient's authorised representative) you must:<br>
•	notify 4RIZON of this fact immediately by email, fax or telephone and delete the Communication from your system, where appropriate;
•	refrain from storing, printing, copying, forwarding, extracting or disclosing any information contained in the Communication or any part thereof; and<br>
•	refrain from reading, storing, using, selling or incorporating any information contained in the Communication into any database or mailing list for whatever reason, including for, but not limited to, purposes of spamming or marketing.<br>
•	Failure to do so may amount to the unlawful interception of the communication; breach of privilege and/or confidentiality; the infringement of copyright and/or the infringement of the right to privacy, thus potentially exposing you to both criminal and civil liability.<br>
<br>
AMENDMENTS<br>
4RIZON reserves its right to amend or wholly replace these Social Terms. You agree that you remain solely responsible for reviewing these Social Terms, as amended from time to time, and satisfying yourself that you remain in agreement with these Social Terms. <br>Amendments to the Social Terms will be placed on this Website and a notice will be placed on this Website alerting the consumer to the amendments. If you do not agree to be any amendment or replacement of the Social Terms you should not continue to access, use and/or consume the Communications or any other form of communication these Social Terms govern.<br>
<br>
LIABILITY LIMITATION<br>
Neither 4RIZON, their affiliates or subsidiaries, the communication’s originator, or any other 4RIZON representative shall be liable for any loss, damage or expense of whatever nature (including without limitation that caused by the corruption or loss of data, damage to software programs and interruption of business operations) resulting directly or indirectly from the transmission of the communication (including without limitation any malicious software code or viruses transmitted together with or obtained through the communication, or any corruption to or loss of data caused or facilitated by the communication).<br>
The views and opinions expressed in the communication do not necessarily reflect 4RIZON’s views and opinions. In particular, no employee or contractor is permitted to send (and you agree that 4RIZON shall not be liable or responsible for):
•	Unsolicited commercial messages where recipients of unsolicited e-mail have not specifically opted to receive or, having done so, have indicated their unwillingness to receive further unsolicited email ("spam");<br>
...
•	If the communication constitutes spam, contains infringing content or offensive content, or was otherwise sent for purposes unrelated to the official business of 4RIZON and shall not be liable for any loss, damage or expense of whatever nature, howsoever arising resulting your receipt, use and/or consumption of the email.<br>
<br>
NO CONTRACT<br>
You agree that you may not rely on the Communication, either wholly or in part, as constituting a contract between you and 4RIZON (or otherwise has any contractual significance whatsoever) unless 4RIZON expressly states, in writing, that the Communication is intended for such purposes.<br>
<br>
<br>
<br>
INDEMNITY <br>
You hereby indemnify us and 4RIZON’s associates from any loss, damages, liability, claim or demand due to or arising out of your use of the gift cards or breach by you of these terms and conditions. <br>
<br>
CONDITIONS APPLICABLE TO ALL PRIZES <br>
Rewards / Discounts may not be exchanged for any cash or other alternative (unless stated) and Reward Vouchers(s) / discounts are non-negotiable, non-transferable, and non-divisible and are not permitted to be sold or resold.<br>
Neither the Promoter nor any redeeming outlet shall be under any obligation to enquire whether the person submitting any voucher code is the person entitled to make the claim, irrespective as to whether or not that person first obtained that voucher code (but without affecting the Promoter's rights concerning anyone in breach of these Terms and Conditions).<br>
ALL voucher(s) will be retained on redemption (unless redeemed via a hotline or online, when the Prize Partner and or Promoter reserves the right to require prior sight of any voucher(s) before redemption) and only Original and Authentic voucher unique codes will be accepted. VOID voucher unique codes will not be accepted (expired, counterfeit, or incomplete).<br>
All pictures and photos used to advertise the prizes are illustrative rather than definitive and are for reference only, the actual prizes may differ in their appearance.<br>
Any advertisement of the cash value of the prize-pool represents the Promoter’s best estimate of the normal retail-price or (in the case of discount prizes) of the discount offered (based in turn on the average discount if variable) for all prizes which are available to be won; it does not thereby imply that any prize will be awarded in the absence of a corresponding valid claim.<br>
Reproduction of any prize imagery does not thereby imply any endorsement or association by the producer of that prize type nor by the owner of any brand associated with that prize type and the award of which has been completed within the time limits as prescribed by these Terms & Conditions.<br>
<br>
RESPONSIBILITY<br>
To the fullest extent permitted by applicable law (but not otherwise) the Promoter, its agents for administering the reward vouchers assume no responsibility and are not liable for: (i) the accuracy or otherwise of the prize description or illustration, (ii) the non-availability, loss, interception or interference with, late receipt or damage of or to any prize claim, Promotional reward vouchers, discount prize(s), voucher(s), prize or notification or other communication, (iii) (other than those warranties or conditions implied by statute and which cannot be excluded by the Promoter) any representation, warranty, condition or guarantee in respect of a prize, or (iv) any taxes, fees, charges or other costs which winners may be required to pay at any time in connection with a prize, (save to the extent that the Promoter has expressly and specifically accepted responsibility in these Terms and Conditions for the same) (v) all costs, injuries, losses or damages of any kind, due in whole or in part, directly or indirectly, to a person’s participation in the Promotion, or arising out of a person’s participation in any Promotion related activity, or their receipt, use or misuse of any prize that may be awarded to them.<br>
<br>
All reward vouchers remain the property of the Promoter, pending redemption to winners and the Promoter reserves the right to dispose of any unclaimed prizes as they deem appropriate.<br>
All prizes remain the property of the Prize Partners, pending redemption by winners and the Promoter is not responsible for the supply of and does not own, any prizes provided by other suppliers nor acts as their agent concerning the delivery to winners of prizes other than those supplied directly by the Promoter.<br>
For any prize which must be claimed by the winners' parent / legal guardian, the Promoter will not be obliged to award it to anyone other than that parent / legal guardian, if the winner is less than 18 years of age. The Promoter may also withhold that award should the Promoter determine in its sole discretion that a dispute may have arisen between the winner and the parent / legal guardian concerning the prize.<br>
The Promoter is not liable to verify the identity of the parent or legal guardian.<br>
The submission of prize claims is the sole responsibility of the prize claimant. Any tax liability or life, health, travel, accident or other insurance associated with any prize is payable by the prize winner and is their sole responsibility.<br>
<br>
THE PROMOTER’S RIGHTS<br>
The Promoter reserves the right and at any time at its absolute discretion and without giving any reason or notice, to vary, modify or amend the terms of these Terms and Conditions in such manner as the Promoter thinks fit. Any changes will be communicated on the Website, and all participants in the Promotion shall be deemed to have accepted such amended or modified terms by their ongoing participation in the Promotion.<br>
In the event of any discrepancy between any printed Terms and Conditions, rules, short guides, declarations, the Terms and Conditions as communicated on the website will prevail.<br>
The Promoter may (i) extend any time limit or waive any of the Terms and Conditions where a person might otherwise have been disqualified (without obliging the Promoter to relax the Terms and Conditions on any further occasion for that entrant or at all for any other person) (ii) terminate or suspend the Promotion at any time due to supervening circumstances beyond the Promoter’s control (iii) substitute a product deemed to be an appropriate replacement and of equal or greater value in the place of any of the prizes (or any part of a prize). The Promoter’s decision in the exercise or interpretation of any of its rights or discretions in connection with these Terms and Conditions shall be final and binding.<br>
<br>
FORCE MAJEURE / PRINTING AND PRODUCTION ERROR.<br>
In the event the Promoter is prevented from continuing with the Promotion as contemplated herein by any event beyond its control, including but not limited to service interruption, technology or system failure, accidental damage, fire, flood, natural or manmade or public health epidemic, earthquake, explosion, labour dispute or strike, an act of public enemy, or equipment failure, riot or civil disturbance, terrorist threat or activity, war (declared or undeclared any provincial or local government law, or regulation, order of any court or jurisdiction, or other cause not reasonably within Promoter’s control (each a “Force Majeure” event or occurrence), then subject to any government approval which may be required, the Promoter shall have the right to modify, suspend, extend or terminate the Promotion.<br>
The Promoter also reserves the right, without prior notice and at any time, to terminate the Promotion, in whole or in part, or modify, suspend, or extend the Promotion in any way, or deem the reward codes void and invalid if it determines, in its sole discretion, that the reward codes in question reflect printing or other errors which have destroyed or severely undermined the proper play, integrity and/or feasibility of the Promotion<br>
If, due to printing or production errors for any reason, more potential winners come forward seeking to claim prizes above the number of each type of prize outlined in these Terms and Conditions, the winners, or r remaining winners, as the case may be, of the advertised number of prizes available in the Promotion may be selected in a random draw from among all persons making purportedly valid claims for such prizes. Inclusion in such a random draw shall be each prize claimant's sole and exclusive remedy under such circumstances.<br>
<br>
LOYALTY<br>
These are the terms and conditions applicable to your use of the 4RIZON loyalty programme and/or loyalty mobile application (“app”).
No person under the age of 18 will be allowed to use the programme/app <br>
All the content, trademarks and data on the app, including text, graphics, icons, and designs belong to us or are licensed to us and may not be copied, downloaded or otherwise used, without permission.<br>
<br>
YOUR PROFILE<br>
You must register a profile on the app before using the app. All information that you provide when registering a profile must be true, accurate and complete.<br>
Providing false information and/or creating multiple profiles constitutes fraud and may lead to your profile being terminated with immediate effect.<br>
It is your responsibility to ensure that no unauthorised persons access your app on your phone.<br>
<br>
YOUR INFORMATION<br>
When registering your profile on the app, we will need to collect certain information from you including your name, surname, identity number and mobile number, as well as your credit or debit card details to accept card payments via the app.<br>
We do not store any credit card data on our system, but we transmit encrypted information (tokens) to the payment service provider to facilitate payments. We do not share any unencrypted credit card information with third parties.<br>
<br>
We only collect as much information as we need to provide the services on the app to you. We will not process or share your information for any other purpose without your permission. By agreeing to these Terms, you give us permission to send you SMS and/or email messages for OTP purposes and purposes relating to orders, queries, marketing and promotions, or for any other lawful reason.<br>
If your location settings are enabled on your mobile device, the app may, from time to time, use GPS (or similar) technology for you to utilize our "Find a Store" feature. However, we do not store or share this location data on our system. We may use app-trackers from time to time, but only for analytics purposes. Data in this regard is anonymous and we do not use it for any marketing purposes.<br>
We have the right to monitor your use of the app to operate and improve the app (including, without limitation, for fraud prevention, risk assessment, investigation and customer support purposes and to ensure your compliance with these Terms and compliance with applicable law).<br>
All data provided to us is stored on our secure servers or those of our trusted service providers. We implement appropriate, generally accepted technical and organizational measures to protect personal data against unauthorised or unlawful processing, accidental loss, destruction or damage, including encryption where appropriate. Unfortunately, the transmission of information via the Internet is not completely secure. We cannot guarantee 100% security of your data transmitted to our servers.<br>
<br>
YOUR USE OF THE PROGRAMME/APP<br>
When using the App, you specifically agree not to upload or transmit any content or engage in any activity that:<br>
•	constitutes an inauthentic or knowingly erroneous rating of your in-store experience;<br>
•	is illegal, or violates any law or regulation;<br>
•	attempts to impersonate another person or entity;<br>
•	accesses or uses the profile of another app user without that user's express permission;<br>
•	interferes with, disrupts, or destroys the functionality or use of any features of the app or the servers or networks connected to the app;<br>
•	“hacks”, or accesses without permission, our proprietary or confidential records, or records of another app user;<br>
•	collects, accesses, or stores personal information about other app users;<br>
•	is posted by a bot.<br>
<br>
GENERAL<br>
There will be times when the availability of the app may be interrupted for scheduled maintenance or upgrades, for emergency repairs, or due to failure of telecommunications links and equipment that are beyond our reasonable control, and we will not be liable for any inconvenience, loss or damage suffered as a result of such interruptions.<br>
The app requires internet access to function. We are not responsible for any interruption to your use of the app due to a lack of internet connection.<br>
<br>
These Terms will be governed and construed following the laws of the Republic of South Africa, and any disputes between you and us relating to these Terms will be subject to the jurisdiction of the relevant South African court.<br>
...
Nothing in these Terms is intended to unlawfully limit or restrict any rights or obligations in terms of the Consumer Protection Act, 2009 or the Protection of Personal Information Act, 2013.<br>
</p>
            <hr />
